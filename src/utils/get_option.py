...
def get_option():
    ...
    ### LossFunction
    parser.add_argument('--loss_func', type=str, choices=['mse', 'mae', 'expweightedloss','weightedmse', 'weightedthresholdmse', 'magnitudeweight', 'logmagnitudeweight', 'focalloss', 'huberloss'])
    ...
    parser.add_argument("--name", type=str, choices=["cnn-lstm", "cnn-lstm-se", "model_v1", "model_v2", "conv-lstm", "strans", "strans-v2", "strans-v3", "strans-v4", "strans-v5", "pred"], default= "model_v1")
    ### early stopping
